...
namespace Ex02
{
    public class Board
    {
        ...
        public static int SetBoardSize()
        {
            ...
            {
                Console.WriteLine(
                    $"Please select board size:{Environment.NewLine}1. 6{Environment.NewLine}2. 8{Environment.NewLine}3. 10");
        ...
        public static ePlayerType GetPlayerOrComputerGame()
        {
            while(true)
            {
                ...
                Console.WriteLine(
                    $"Do you want to play against another player or the computer?{Environment.NewLine}1. Player vs. player{Environment.NewLine}2. Player vs. computer");
                string choice = Console.ReadLine();
